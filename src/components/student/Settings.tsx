                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border text-black border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex justify-end">
                    <button
                      ...
                      disabled={saving}
                      className="px-6 py-2 bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-400 text-white rounded-md transition-colors font-medium"
                    >
