        ...
        <div className="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full sm:p-6">
          <form onSubmit={handleSubmit}>
            ...
            <div className="sm:flex sm:items-start mb-6">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <p className="text-sm text-gray-500">
                  Create a new user account with role and access permissions.
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`flex-1 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 text-black ${
                ...
                <div className="flex space-x-2">
                  <div className="flex-1 relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 pr-10 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 text-black ${
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-6">
              <h4 className="text-sm font-medium text-blue-900 mb-2">Account Creation Info</h4>
              <div className="text-xs text-blue-700 space-y-1">
                <div>• The user will be able to log in with the provided username and password</div>
                <div>• Account status can be changed later in the user management section</div>
                <div>• Role permissions will be applied immediately upon creation</div>
                <div>• An email notification will be sent to the user (if email service is configured)</div>
              </div>
            </div>
